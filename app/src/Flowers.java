...
public class Flowers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView  text1 = findViewById(R.id.editText6);
        TextView  text2 = findViewById(R.id.editText7);
        TextView  text3 = findViewById(R.id.editText16);
        TextView  text4 = findViewById(R.id.editText14);
        TextView  text5 = findViewById(R.id.editText5);
        TextView  text6 = findViewById(R.id.editText18);
        TextView  text7 = findViewById(R.id.editText10);
        ...
        deneme9.setImageResource(R.drawable.a1);
        deneme2.setImageResource(R.drawable.a2);
        deneme3.setImageResource(R.drawable.a3);
        deneme1.setImageResource(R.drawable.a4);
        deneme5.setImageResource(R.drawable.a5);
        deneme6.setImageResource(R.drawable.a6);
        deneme4.setImageResource(R.drawable.a7);
        deneme8.setImageResource(R.drawable.a8);
        deneme7.setImageResource(R.drawable.a9);
